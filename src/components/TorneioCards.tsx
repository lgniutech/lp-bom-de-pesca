  ...
  return (
    <div className="w-full flex flex-col gap-8">
      ...
      <AnimateOnScroll direction="left">
        <Link
          href="https://drive.google.com/file/d/1I6TJUkkEePNO1nRABe7XCe0pLtSLHvNl/view?usp=sharing"
          target="_blank"
        ...
        >
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between py-8 md:py-10 px-6 md:px-12 gap-8">
            ...
            <div className="relative w-44 md:w-56 aspect-square flex-shrink-0 flex items-center justify-center p-2 bg-[#0b141a]/60 rounded-2xl border border-white/5 shadow-inner">
              <Image
                src="/images/brasao-4-torneio.jpg"
      ...
      <AnimateOnScroll direction="right">
        <div className="relative w-full max-w-5xl mx-auto bg-[#1a1b2e] rounded-[2rem] overflow-hidden shadow-2xl border border-amber-500/30">
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between py-8 md:py-10 px-6 md:px-12 gap-8">
            ...
            <div className="relative w-44 md:w-56 aspect-square flex-shrink-0 flex items-center justify-center p-2 bg-[#0b141a]/60 rounded-2xl border border-amber-500/20 shadow-inner">
              <Image
                src="/images/brasao-4-torneio.jpg"
                alt="Brasão 4º Torneio Bom de Pesca"
                width={200}
                height={200}
                className="object-contain max-h-full opacity-90"
              />
            </div>
          </div>
        </div>
