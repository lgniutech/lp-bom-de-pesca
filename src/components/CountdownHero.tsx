...
export default function CountdownHero() {
  ...
  return (
    <div className="relative w-full max-w-5xl mx-auto my-4 sm:my-6 group">
      ...
      <div className="relative z-10 p-[2px] sm:p-[3px] rounded-[2rem] sm:rounded-[2.5rem] bg-gradient-to-r from-[#f26419] via-[#ffb703] to-[#f26419] animate-border-glow shadow-[0_20px_60px_rgba(242,100,25,0.35)]">
        ...
        {/* NÚCLEO EM VIDRO ESCURO COM CONTEÚDO INTEGRADO */}
        <div className="relative z-10 w-full bg-[#0e0f1d]/95 backdrop-blur-2xl rounded-[1.85rem] sm:rounded-[2.35rem] p-5 sm:p-8 md:p-10 border border-white/15 overflow-hidden shadow-[inset_0_2px_4px_rgba(255,255,255,0.2)]">
          ...
          <div className="relative z-20 flex flex-col gap-6 sm:gap-8">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8 text-center md:text-left">
              ...
              <div className="flex-1 max-w-2xl w-full">
                ...
                <div className="w-16 h-1 bg-[#f26419] rounded-full mb-4 mx-auto md:mx-0"></div>
              ...
              {/* Lado Direito: Brasão do 4º Torneio com Iluminação */}
              <div className="relative w-36 sm:w-44 md:w-52 aspect-square flex-shrink-0 flex items-center justify-center p-1">
                <Image
                  ...
                  height={220}
                  priority
                  className="object-contain max-h-full transition-transform duration-500 drop-shadow-[0_10px_25px_rgba(0,0,0,0.7)] group-hover:scale-105 group-hover:drop-shadow-[0_15px_30px_rgba(242,100,25,0.5)]"
                />
              </div>

            </div>

            {/* 3. PLACAR ELETRÔNICO 3D (DÍGITOS DO CRONÔMETRO) */}
