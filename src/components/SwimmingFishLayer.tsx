...
export default function SwimmingFishLayer() {
  ...
  return (
    ...
    >
      {/* 1. TUCUNARÉ REALISTA 1 (Boca para a esquerda) — Nadando para a ESQUERDA em PNG 100% Transparente */}
      <div className="absolute top-[20%] -right-40 w-56 sm:w-80 opacity-80 blur-[0.2px] animate-swim-left">
        <Image
      ...
      {/* 2. TUCUNARÉ REALISTA 2 (Boca para a direita) — Nadando para a DIREITA em PNG 100% Transparente */}
      <div className="absolute top-[52%] -left-40 w-48 sm:w-72 opacity-85 blur-[0.1px] animate-swim-right">
        <Image
      ...
      <div className="absolute top-[78%] -right-48 w-64 sm:w-96 opacity-45 blur-[1.5px] animate-swim-left-slow">
        <Image
          src="/images/peixe-tucunare-1.png"
          alt=""
          width={380}
